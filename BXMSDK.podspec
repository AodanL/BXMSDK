#
# Be sure to run `pod lib lint BXMSDK.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.author           = { 'aodanl' => 'aodan@aodan.me' }
  s.source           = { :git => 'https://github.com/aodanl/BXMSDK.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'BXMSDK/Classes/**/*'
  
  # s.resource_bundles = {
  #   'BXMSDK' => ['BXMSDK/Assets/*.png']
  # }
